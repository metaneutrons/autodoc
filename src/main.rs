...
async fn main() -> Result<()> {
    ...
    match cli.command {
        ...
        Commands::Templates { action } => {
            ...
            match action {
                Some(TemplateCommands::List) => match template_manager.list_templates() {
                    Ok(templates) => {
